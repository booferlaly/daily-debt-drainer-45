...
import CreditBureauReporting from '@/components/credit/CreditBureauReporting';
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="simulator" className="space-y-4">
        <TabsList>
          <TabsTrigger value="simulator">Credit Score</TabsTrigger>
          <TabsTrigger value="reporting">Credit Reporting</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="reporting">
          <CreditBureauReporting debts={debts} />
        </TabsContent>
      </Tabs>
    </div>
  );
